...
namespace AsposeVisualStudioPlugin.Core
{
    public class Constants
    {
        ...
        public static string ASPOSE_PDF = "Aspose.Pdf";
        public static string ASPOSE_SLIDES = "Aspose.Slides";
        public static string ASPOSE_DIAGRAM = "Aspose.Diagram";
        public static string ASPOSE_BARCODE = "Aspose.BarCode";
        public static string ASPOSE_TASKS = "Aspose.Tasks";
        ...
        public static string ASPOSE_WORDS_FEATURE_TEXT =
                "Aspose.Words for .NET is an advanced " +
